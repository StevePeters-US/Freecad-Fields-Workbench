...
class SdfRevolutionField(SdfField):
    ...
    def to_glsl(self, ctx, point_var: str = "p") -> str:
        func_name = ctx.get_unique_name("sdf_revolve")

        offset_u = ctx.uniform("float", self.offset)
        sub_p = f"{func_name}_rq"
    ...
    def bounding_box(self):
        ...
        try:
            ...
            fld_logger.debug(f"SdfRevolutionField.bounding_box radial extent estimation failed, defaulting to 1000.0: {e}")
            r_profile = 1000.0

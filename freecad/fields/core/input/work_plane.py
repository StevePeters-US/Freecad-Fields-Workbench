...
class WorkPlaneManager:
    ...
    def __init__(self, view):
        ...
        self.root_node.setName("Fld_WorkPlane_Root")
    ...
    def update(self, event_dict):
        ...
        self.current_placement = FldInputManager.get_instance().get_view_transform(self.view, mouse_pt)
        ...
        try:
            ...
            fld_logger.debug(f"WorkPlane scale update failed: {e}")
